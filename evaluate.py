...
if __name__ == '__main__':
    ...
    print("printing dnffw in next line")
    print(dn_ffw)

    trainer = TrainAgent(my_agent, env, env, device, dn_json_path, None, dn_ffw, ep_infos, None)

    if not os.path.exists(output_result_dir):
        os.makedirs(output_result_dir)
    
    plot_topo = True
    trainer.evaluate(model_name, test_chronics, MAX_FFW[args.case], output_result_dir, mode, plot_topo)
